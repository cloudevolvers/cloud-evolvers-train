      ...
      >
        ...
        <div className="relative z-10">
          <div className="flex items-center gap-4 mb-6">
            ...
            <div>
              <div className="text-foreground/70 font-medium">Advanced Level</div>
      ...
      >
        ...
        <div className="space-y-8">
          <div className="bg-slate-800 rounded-xl p-6 border border-border">
            <div className="flex items-center gap-3 mb-4">
              <div className="bg-neutral-800/20 p-2 rounded-lg">
                <Desktop className="text-foreground/70 h-6 w-6" />
              </div>
          ...
          <div className="bg-slate-800 rounded-xl p-6 border border-border">
            <div className="flex items-center gap-3 mb-4">
              <div className="bg-neutral-800/20 p-2 rounded-lg">
                <Monitor className="text-foreground/70 h-6 w-6" />
              </div>
