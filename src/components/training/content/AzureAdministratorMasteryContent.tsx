      ...
      >
        ...
        <div className="relative z-10">
          <div className="flex items-center gap-4 mb-6">
            ...
            <div>
              <div className="text-foreground/70 font-medium">Intermediate Level</div>
          ...
          <h1 className="text-white font-bold mb-4">
            Azure Administrator
            <span className="text-foreground/80 block">Mastery</span>
          </h1>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <div className="bg-slate-800/60 flex items-center gap-3 backdrop-blur-sm rounded-lg p-4">
              <Certificate className="text-foreground/70 h-5 w-5" />
              <div>
      ...
      >
        ...
        <div className="space-y-6">
          <div className="bg-slate-800 border-slate-700 rounded-xl p-6">
            <div className="flex items-center gap-3 mb-4">
              <div className="bg-neutral-800/20 p-2 rounded-lg">
                <Shield className="text-foreground/70 h-5 w-5" />
              </div>
          ...
          <div className="bg-slate-800 border-slate-700 rounded-xl p-6">
            <div className="flex items-center gap-3 mb-4">
              <div className="bg-neutral-800/20 p-2 rounded-lg">
                <Gear className="text-foreground/70 h-5 w-5" />
              </div>
        ...
        >
          ...
          <div className="space-y-3">
            {trainingMetadata.targetAudience.map((audience, index) => (
              <div key={index} className="bg-neutral-800/20 flex items-start gap-3 p-3 rounded-lg">
                <Users className="text-foreground/70 h-5 w-5 flex-shrink-0 mt-0.5" />
