...
const BentoCard = ({ title, description, to, image, exploreLabel }: BentoCardProps) => {
    return (
        <Link
            to={to}
            className={cn(
                "group relative overflow-hidden rounded-2xl border border-brand-200 bg-white transition-all hover:border-brand-300 hover:shadow-md"
            )}
        >
            {/* Photo header */}
            {image && (
            ...
            <div className="relative z-10 flex flex-col p-5">
                ...
                <div className="mt-4 inline-flex items-center text-sm font-medium text-brand-700 transition-transform group-hover:translate-x-1">
...
export function BentoFeatures() {
    ...
    return (
        <section className="relative z-10 border-t border-brand-100 bg-white py-16 sm:py-20 lg:py-24">
            <div className="container mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                <div className="mb-20 flex flex-col gap-5 md:flex-row md:items-end md:justify-between">
                    <div className="max-w-2xl">
                        <h2 className="font-display text-3xl font-semibold text-brand-900 md:text-5xl">
                    ...
                    <Link to="/training">
                        <Button variant="ghost" className="text-brand-500 hover:text-brand-900">
                ...
                <div className="grid grid-cols-1 gap-5 lg:grid-cols-[minmax(0,1.2fr)_minmax(0,0.8fr)]">
                    <Link
                        ...
                        className="group relative overflow-hidden rounded-[2rem] border border-brand-200 bg-brand-50/50 shadow-sm transition-all hover:border-brand-300 hover:shadow-md"
                    >
                        ...
                        <div className="relative z-10 flex min-h-[280px] flex-col p-8 lg:p-10">
                            <div className="flex items-center justify-between">
                                <div className="rounded-full border border-brand-200 bg-brand-100 px-3 py-1 text-xs font-semibold uppercase tracking-[0.16em] text-brand-700">
                                    {b?.featuredLabel || "Most requested by teams"}
                                </div>
                                <ArrowUpRight className="h-5 w-5 text-brand-400 transition-transform group-hover:-translate-y-0.5 group-hover:translate-x-0.5" />
                            </div>

                            <p className="mt-12 text-sm font-medium uppercase tracking-wider text-brand-400">
                                {b?.featuredKicker || "Operations track"}
                            </p>
                            <h3 className="font-display mt-3 max-w-lg text-3xl font-semibold text-brand-900 lg:text-4xl">
                                {b?.featuredTitle || "AZ-104 for admins who need to run Azure well."}
                            </h3>
                            <p className="mt-5 max-w-xl text-base leading-7 text-brand-600">
                            ...
                            <div className="mt-auto pt-12">
                                <span className="inline-flex items-center text-sm font-medium text-brand-700 transition-transform group-hover:translate-x-1">
                    ...
                    <div className="grid gap-5 sm:grid-cols-2">
                        ...
                        <Link
                            to="/contact"
                            className="group rounded-2xl border border-brand-200 bg-white p-6 transition-all hover:border-brand-300 hover:shadow-sm"
                        >
                            <div className="flex h-full flex-col">
                                ...
                                <div className="mt-6 flex items-center gap-2 text-sm font-medium text-brand-900 transition-transform group-hover:translate-x-1">
                ...
                <Link
                    to="/about"
                    className="group mt-6 block rounded-2xl border border-brand-200 bg-white p-6 shadow-sm transition-all hover:border-brand-300 hover:shadow-md sm:p-8"
                >
                    <div className="flex flex-col gap-5">
                        <div className="inline-flex w-fit items-center rounded-full border border-brand-200 bg-brand-50 px-3 py-1.5 text-xs font-semibold uppercase tracking-[0.16em] text-brand-600">
                            {b?.mctTrainer || "Microsoft Certified Trainer"}
                        </div>
                        <h3 className="font-display text-3xl font-semibold text-brand-900">
                            {b?.founderTitle || "Yaïr leads the training, not a generic content library."}
                        </h3>
                        <p className="max-w-3xl text-base leading-8 text-brand-600">
                        ...
                        <span className="inline-flex items-center text-sm font-medium text-brand-900 transition-transform group-hover:translate-x-1">
