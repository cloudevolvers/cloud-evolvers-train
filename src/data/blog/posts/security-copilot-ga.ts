    ...
    sections: [
      ...
      },
      {
        ...
        content: {
          ...
          nl: 'De twee killer features in dagelijks SOC-werk zijn natuurlijke taal naar KQL-vertaling en incidentsamenvatting. Voor KQL beschrijf je wat je zoekt in gewoon Nederlands — "toon me alle mislukte aanmeldpogingen van IP-bereiken buiten Nederland in de laatste 24 uur" — en Security Copilot genereert een werkende KQL-query tegen je Sentinel-werkruimte. Het kent je tabelschema\'s en aangepaste kolommen. Voor analisten die geen KQL-experts zijn, is dit transformatief. Het verwijdert de barrière tussen weten wat je moet vinden en in staat zijn ernaar te zoeken. Incidentsamenvatting neemt een complex, multi-alert incident met tientallen events en produceert een leesbaar verhaal: wat er is gebeurd, welke entiteiten betrokken waren, wat de tijdlijn was en wat de potentiële impact is. Een Tier 1-analist kan deze samenvatting lezen en onmiddellijk begrijpen of escalatie nodig is. In omgevingen die dagelijks honderden incidenten verwerken, rechtvaardigt dit alleen al de investering.'
        }
      },
      {
        title: {
