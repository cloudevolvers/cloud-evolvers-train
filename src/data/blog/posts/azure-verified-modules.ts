...
module virtualNetwork 'br/public:avm/res/network/virtual-network:0.5.0' = {
  ...
  params: {
    ...
    conclusion: {
      ...
      nl: 'AVM vervangt je custom modules voor organisatiespecifieke patronen niet. Maar voor standaard resources — VNets, Key Vaults, storage accounts — is er weinig reden meer om je eigen te onderhouden. Je krijgt geteste releases, semantische versiebeheer en een community die de code up-to-date houdt. Het nadeel? Je vertrouwt op Microsofts interfacebeslissingen, en sommige modules lopen nog achter qua feature-dekking. Probeer eerst één module te vervangen in een dev-omgeving. Als het werkt, wissel er meer. Als een module je use case niet dekt, de repo\'s zijn publiek — maak een issue aan of draag bij.'
    }
  }
};
