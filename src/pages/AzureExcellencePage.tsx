      ...
      >
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-4xl mx-auto text-center">
            <h2 className="text-3xl font-bold mb-6">Why Choose Our Azure Excellence Program?</h2>
            <p className="text-lg text-muted-foreground leading-relaxed">
              Our comprehensive Azure and Microsoft Stack Excellence program is designed to elevate your 
              technical expertise and career prospects. With hands-on labs, real-world case studies, 
              and guidance from Microsoft Certified Trainers, you'll gain the skills needed to excel 
