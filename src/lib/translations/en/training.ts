export default {
  ...
  detail: {
    ...
    noLearningObjectives: 'No learning objectives available.',
    courseModules: 'Course Modules',
    modulesCurriculum: 'Structured curriculum for complete mastery',
    ...
    inquireAboutTraining: 'Inquire About Training',
    featured: 'Featured',
