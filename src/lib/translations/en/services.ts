export default {
  title: "Comprehensive Azure Services",
  subtitle: "Beyond training, we offer full-spectrum Azure consulting and management services",
  items: [
    {
      title: "Azure API Monitoring",
      description: "Real-time visibility into your Azure resources with custom dashboards and alerts",
      features: ["Resource monitoring", "Custom alert configurations", "Performance analytics", "Resource usage trends"]
    },
    {
      title: "Cloud Management",
      description: "Proactive management and optimization of your Azure cloud infrastructure",
      features: ["Infrastructure monitoring & maintenance", "Security posture management", "Performance tuning", "Backup and disaster recovery"]
    },
    {
    ...
    },
    {
      ...
      description: "Plan and train a Microsoft 365 Copilot rollout with governance, prompts, and adoption support",
      features: ["Copilot implementation", "AI productivity training", "Workflow optimization", "Change management"]
    },
    {
    ...
    },
    {
      ...
      description: "Design and implement Azure networking that operators can understand and support",
      features: ["Network design", "Implementation", "Security management", "Performance optimization"]
    },
    {
      title: "AI Engineering & Consultancy",
      description: "Validate AI use cases, data readiness, and Azure OpenAI architecture before teams spend on a build",
      features: ["Machine learning implementation", "AI strategy", "Intelligent automation", "Data science consulting"]
    }
  ],
