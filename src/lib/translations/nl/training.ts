export default {
  ...
  overview: {
    ...
    courses: {
      "azure-administrator-mastery": {
        ...
        description: "Beheers geavanceerde Azure-administratie met uitgebreide vaardigheden voor resourcebeheer"
      },
      "azure-fundamentals": {
        title: "Azure Fundamentals (AZ-900)",
        description: "Bouw fundamentele kennis op van Azure cloud services en kernconcepten"
      },
      "azure-developer": {
        title: "Azure Developer Associate (AZ-204)",
        description: "Ontwikkel cloud-oplossingen op Microsoft Azure met end-to-end oplossingen"
      },
      "azure-solutions-architect": {
        title: "Azure Solutions Architect Expert (AZ-305)",
        description: "Ontwerp schaalbare en veilige enterprise Azure-oplossingen"
      },
      "azure-security-engineer": {
        title: "Azure Security Engineer Associate (AZ-500)",
        description: "Implementeer uitgebreide Azure beveiligingscontroles en bescherm identiteiten"
      },
      "microsoft-365-fundamentals": {
        title: "Microsoft 365 Fundamentals (MS-900)",
        description: "Bouw fundamentele kennis op van Microsoft 365 cloud productiviteitsdiensten"
      },
      "power-platform-fundamentals": {
        title: "Power Platform Fundamentals (PL-900)",
        description: "Leer de basis van Microsoft Power Platform voor bedrijfsautomatisering"
      },
      "azure-ai-fundamentals": {
        title: "Azure AI Fundamentals (AI-900)",
        description: "Verken de fundamenten van kunstmatige intelligentie in Azure"
      },
      "azure-devops-engineer": {
        title: "Azure DevOps Engineer Expert (AZ-400)",
        description: "Implementeer DevOps-praktijken voor continue integratie en deployment"
      },
      "azure-network-engineer": {
        title: "Azure Network Engineer Associate (AZ-700)",
        description: "Ontwerp en implementeer Azure-netwerkoplossingen"
      },
      ...
      "power-platform-automation": {
        ...
        description: "Ontwikkel geavanceerde automatiseringsoplossingen met Power Platform"
      },
      "security-compliance-identity-fundamentals": {
        title: "Security, Compliance & Identity Fundamentals (SC-900)",
        description: "Leer de basisprincipes van beveiliging en compliance in Microsoft cloud"
      },
      "microsoft-365-copilot-mastery": {
        title: "Microsoft 365 Copilot Mastery",
        description: "Beheers Microsoft 365 Copilot voor maximale productiviteit"
      },
      "azure-ai-developer-bootcamp": {
        title: "Azure AI Developer Bootcamp",
        description: "Intensieve training voor AI-ontwikkeling op Azure-platform"
      },
      "azure-security-fundamentals": {
        title: "Azure Security Fundamentals",
        description: "Fundamentele beveiligingsconcepten voor Azure cloud-omgevingen"
      },
      "azure-iot-developer": {
      ...
      "azure-ai-developer": {
        ...
        description: "Bouw AI-oplossingen met Azure Cognitive Services"
      },
      "microsoft-365-security-administrator": {
        title: "Microsoft 365 Security Administrator Associate (MS-500)",
        description: "Implementeer beveiliging en compliance in Microsoft 365"
      },
      "microsoft-365-identity-access-administrator": {
        title: "Microsoft 365 Identity and Access Administrator Associate (MS-500)",
        description: "Beheer identiteit en toegang in Microsoft 365-omgevingen"
      },
      "teams-advanced-administration": {
        title: "Teams Advanced Administration",
        description: "Geavanceerd beheer van Microsoft Teams-omgevingen"
      },
      "azure-stack-hub": {
        title: "Azure Stack Hub",
        description: "Implementeer en beheer Azure Stack Hub hybride cloud-oplossingen"
      },
      "azure-support-engineer": {
        title: "Azure Support Engineer",
        description: "Professionele ondersteuning en probleemoplossing voor Azure"
      },
      ...
      "windows-server-hybrid-infrastructure": {
        ...
        description: "Implementeer hybride infrastructuur met Windows Server"
      }
    }
  },
  popular: {
  ...
  azure: {
    ...
    courses: [
      ...
      { code: "AZ-204", name: "Azure Developer Associate", level: "Gevorderd" },
      { code: "AZ-305", name: "Azure Solutions Architect Expert", level: "Expert" },
      { code: "AZ-500", name: "Azure Security Engineer Associate", level: "Gevorderd" },
      { code: "AZ-400", name: "Azure DevOps Engineer Expert", level: "Expert" },
      { code: "AZ-700", name: "Azure Network Engineer Associate", level: "Gevorderd" },
      { code: "AI-102", name: "Azure AI Engineer Associate", level: "Gevorderd" },
  ...
  microsoft365: {
    ...
    subtitle: "AI-gestuurde productiviteit en samenwerking",
    courses: [
      { code: "MS-900", name: "Microsoft 365 Fundamentals", level: "Beginner" },
      { code: "MS-102", name: "Microsoft 365 Enterprise Administrator", level: "Gevorderd" },
      { code: "SC-300", name: "Microsoft 365 Identity & Access Administrator", level: "Gevorderd" },
      { code: "SC-400", name: "Microsoft 365 Security Administrator", level: "Gevorderd" },
      { code: "Custom", name: "Microsoft 365 Copilot Mastery", level: "Gemiddeld" },
      { code: "MS-721", name: "Teams Advanced Administration", level: "Gevorderd" }
    ]
  },
  powerPlatform: {
    ...
    courses: [
      ...
      { code: "PL-400", name: "Power Platform Developer Associate", level: "Gevorderd" },
      { code: "Custom", name: "Power Platform Automation Bootcamp", level: "Gevorderd" }
    ]
  },
  security: {
  ...
  detail: {
    ...
    loading: 'Trainingsgegevens worden geladen...',
    courseOverview: 'Cursusoverzicht',
    personalStory: 'Persoonlijk Verhaal',
    learningObjectives: 'Leerdoelen',
    noLearningObjectives: 'Geen leerdoelen beschikbaar.',
    courseModules: 'Cursusmodules',
    modulesCurriculum: 'Gestructureerd curriculum voor volledige beheersing',
    prerequisites: 'Vereisten',
    targetAudience: 'Doelgroep',
    instructor: 'Docent',
    expertInstructor: 'Expert Docent',
    mctTrainer: 'Microsoft Certified Trainer',
    topicsCovered: 'Behandelde Onderwerpen',
    inquireAboutTraining: 'Informeer over Training',
    featured: 'Uitgelicht',
