...
- **Suggested command**: Which command to use (prefer: /quieter, /polish, /optimize, /onboard, /normalize, /harden, /extract, /distill, /delight, /critique, /colorize, /clarify, /bolder, /audit, /animate, /adapt — or other installed skills you're sure exist)
...
Map issues to available commands. Prefer these: /quieter, /polish, /optimize, /onboard, /normalize, /harden, /extract, /distill, /delight, /critique, /colorize, /clarify, /bolder, /audit, /animate, /adapt. You may also suggest other installed skills you're sure exist, but never invent commands.
